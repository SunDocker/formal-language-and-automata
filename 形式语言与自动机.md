...
> <img src="typora-user-images\image-20220225092645819.png" alt="image-20220225092645819" style="zoom:67%;" />

#### (三) 字符串相关运算

- *字符串的**长度***：字符串中符号所占位置个数，记为$|字符串|$

  > <img src="typora-user-images\image-20220225092932307.png" alt="image-20220225092932307" style="zoom:67%;" />

- *字符串的**连接***：将**首尾相接**得到新字符串的运算，记为$x·y$或$xy$

  > <img src="typora-user-images\image-20220225093118503.png" alt="image-20220225093118503" style="zoom:67%;" />
...
- *字符串的幂*
  ...
  <img src="typora-user-images\image-20220225093408534.png" alt="image-20220225093408534" style="zoom:67%;" />

#### (四) 集合相关运算

- *集合的连接*

  <img src="\typora-user-images\image-20220225093518798.png" alt="image-20220225093518798" style="zoom:67%;" />

  > 就是两个集合中的**字符串连接**，是有前后顺序的

- *集合的幂*

  <img src="typora-user-images\image-20220225093628548.png" alt="image-20220225093628548" style="zoom:67%;" />

> 注意区分**集合**与**字母表**，一般来说，只有字母表中的元素叫做“**字符**/符号”，集合中的叫做**字符串**

- *克林闭包*、*正闭包*

  <img src="typora-user-images\image-20220225094403235.png" alt="image-20220225094403235" style="zoom:67%;" />

  <img src="typora-user-images\image-20220225094434100.png" alt="image-20220225094434100" style="zoom:67%;" />

  > 显然：
  >
  > <img src="typora-user-images\image-20220225094458372.png" alt="image-20220225094458372" style="zoom:67%;" />
...
- 定义：
  ...
  <img src="typora-user-images\image-20220225103408161.png" alt="image-20220225103408161" style="zoom:67%;" />

  > ==字母表**克林闭包**的子集==

  > <img src="typora-user-images\image-20220225103620308.png" alt="image-20220225103620308" style="zoom:67%;" />
  >
...
<img src="typora-user-images\image-20220225103848444.png" alt="image-20220225103848444" style="zoom:67%;" />
...
<img src="typora-user-images\image-20220225104207754.png" alt="image-20220225104207754" style="zoom:67%;" />

- 对**结构**进行归纳

  <img src="typora-user-images\image-20220225104459342.png" alt="image-20220225104459342" style="zoom:67%;" />
...
- 结构示例
  ...
  <img src="typora-user-images\image-20220225105113316.png" alt="image-20220225105113316" style="zoom:67%;" />

- :star:==确定的有穷自动机的形式定义==

  <img src="typora-user-images\image-20220225110252614.png" alt="image-20220225110252614" style="zoom:67%;" />
...
- 状态转移表
  ...
  <img src="typora-user-images\image-20220225112044215.png" alt="image-20220225112044215" style="zoom:67%;" />

- 典型问题：设计DFA使其**接受且仅接受**给定的**语言L**

> 举例：两个有穷状态自动机的**笛卡尔积**，让两个自动机一起跑
>
> <img src="typora-user-images\image-20220225112541979.png" alt="image-20220225112541979" style="zoom:67%;" />
>
> 给状态编号，然后分类讨论：
>
> - 将**状态集**也作**笛卡尔积**，得到更多的状态
> - 选择合适的初始状态，然后根据**输入**写状态转移表
>
...
- :star:**扩展转移函数**
  ...
  <img src="typora-user-images\image-20220225112844015.png" alt="image-20220225112844015" style="zoom:67%;" />

> 扩展转换函数**处理**过程举例：
>
> <img src="typora-user-images\image-20220225113018434.png" alt="image-20220225113018434" style="zoom:67%;" />

> 扩展转换函数证明题举例：对**结构**归纳
>
> <img src="typora-user-images\image-20220225113622322.png" alt="image-20220225113622322" style="zoom:67%;" />

- :star:**DFA的语言**和**正则语言**

  <img src="typora-user-images\image-20220225113816903.png" alt="image-20220225113816903" style="zoom:67%;" />

> 题目举例：
>
> <img src="typora-user-images\image-20220225115001087.png" alt="image-20220225115001087" style="zoom:67%;" />
>
> 读的过程就是**右移**的过程，就是**乘二**或者**乘二加一**
>
> DFA不知道当前是否是最后一个，所以必须考虑如果当前是最后一个，要不要接收，即当前状态要能记住，当前的数除3余几，只有0，1，2三种余数，所以有三个重要状态，可以先画出状态转移表（图中的表把q去掉，就是最原始的余数转移表）
>
> 从高位向低位读的
...
> 理解状态转移的非确定性：
>
> <img src="typora-user-images\image-20220225115742335.png" alt="image-20220225115742335" style="zoom:67%;" />
>
...
> 确定与非确定的举例：
>
> <img src="typora-user-images\image-20220225120100163.png" alt="image-20220225120100163" style="zoom:67%;" />

#### (一) 形式语言

- :star:==非确定有穷自动机的形式定义==

  <img src="typora-user-images\image-20220225120527627.png" alt="image-20220225120527627" style="zoom:67%;" />

  > 状态转移的过程相当于一棵**树**

> NFA五元组举例分析：
>
> <img src="typora-user-images\image-20220225121111582.png" alt="image-20220225121111582" style="zoom:67%;" />
>
> 如果(所有)下一个状态集合(的**并集**)是空集，状态机就会卡住，进入死状态，不会接收字符串
>
> <img src="typora-user-images\image-20220225121442147.png" alt="image-20220225121442147" style="zoom:67%;" />
>
> 只要最后的状态集合**包含可接收的状态**，就认为可接收字符串
>
> NFA的状态转移表如下：
>
> <img src="typora-user-images\image-20220225121629481.png" alt="image-20220225121629481" style="zoom:67%;" />

#### (二) 扩展转移函数与NFA语言

- NFA 的扩展转移函数

<img src="typora-user-images\image-20220301083342074.png" alt="image-20220301083342074" style="zoom:67%;" />

> 建议与 DFA 的对比

- NFA 的语言

  <img src="typora-user-images\image-20220301083630517.png" alt="image-20220301083630517" style="zoom:67%;" />

> NFA 设计举例：
>
> $\Rarr$有误的例子
>
> <img src="typora-user-images\image-20220301084205809.png" alt="image-20220301084205809" style="zoom:67%;" />
>
> > 注意，这个设计有误，不能接收单字符
>
> $\Rarr$两类可接收状态的 **NFA 拼接**与==分类讨论==
>
> ![image-20220301084926342](typora-user-images\image-20220301084926342.png)
...
- :star:定理1：如果语言L被NFA接受，当且仅当L被DFA接受
  ...
  > :star:证明：==**子集构造法**==
  >
  > <img src="typora-user-images\image-20220301085809176.png" alt="image-20220301085809176" style="zoom:67%;" />
  >
  > > NFA 能接收多个状态，
  > >
  > > DFA 就直接**包装成一个集合**，整体再当作**一个状态**
  >
  > <img src="typora-user-images\image-20220301090215571.png" alt="image-20220301090215571" style="zoom:67%;" />
  >
  > <img src="typora-user-images\image-20220301090358501.png" alt="image-20220301090358501" style="zoom:67%;" />
  >
  > > NFA 与 DFA 识别的语言相同
...
> 子集构造法举例：NFA状态转移图$\rarr$NFA状态转移表$\rarr$DFA状态转移表$\rarr$DFA状态转移图
>
> 借助 NFA 的状态表，
>
...
> > 接收状态就是与接收状态集F的交集不为空
>
> <img src="typora-user-images\image-20220301094752580.png" alt="image-20220301094752580" style="zoom:67%;" />
...
- 状态的$\epsilon$转移
  ...
  <img src="typora-user-images\image-20220301095424240.png" alt="image-20220301095424240" style="zoom50%;" />

  > 空转移设计举例：
  >
  > <img src="typora-user-images\image-20220301095506678.png" alt="image-20220301095506678" style="zoom:67%;" />

- :star:**==形式定义==**

  <img src="typora-user-images\image-20220301100337301.png" alt="image-20220301100337301" style="zoom:67%;" />

  > $\epsilon-NFA,NFA,DFA$对比：
  >
  > <img src="typora-user-images\image-20220301100559004.png" alt="image-20220301100559004" style="zoom:67%;" />
  >
  > <img src="typora-user-images\image-20220301100613198.png" alt="image-20220301100613198" style="zoom:67%;" />

> 举例：
>
> <img src="typora-user-images\image-20220301100732790.png" alt="image-20220301100732790" style="zoom:67%;" />
>
> 所以之后写 NFA 的时候，如果**空转移不都为死状态**，应该写上这一列

#### (二) $\epsilon$闭包

> 介绍这个闭包主要是为了$\epsilon-NFA$转DFA时把可能的状态写全

> NFA 读入分析：
>
> <img src="typora-user-images\image-20220301101056219.png" alt="image-20220301101056219" style="zoom:67%;" />
>
> 空转移要写全

- :star:状态的$\epsilon$闭包

  <img src="typora-user-images\image-20220301101356351.png" alt="image-20220301101356351" style="zoom:67%;" />

- :star:状态集的$\epsilon$闭包

  <img src="typora-user-images\image-20220301101449757.png" alt="image-20220301101449757" style="zoom:67%;" />

> 举例：
>
> <img src="typora-user-images\image-20220301101654250.png" alt="image-20220301101654250" style="zoom:67%;" />
>
...
- :star:扩展转移函数
  ...
  <img src="typora-user-images\image-20220304103834452.png" alt="image-20220304103834452" style="zoom:67%;" />

  > 举例：
  >
  > <img src="typora-user-images\image-20220304103937159.png" alt="image-20220304103937159" style="zoom:67%;" />
  >
  > > 其实就是多了一步==求闭包==

- :star:$\epsilon-NFA$的语言

  <img src="typora-user-images\image-20220304104008638.png" alt="image-20220304104008638" style="zoom:67%;" />

#### (四) $\epsilon-NFA$与$DFA$等价性

- 证明：子集构造法（消除空转移）

  <img src="typora-user-images\image-20220304104403019.png" alt="image-20220304104403019" style="zoom:50%;" />

  > 举例理解这个构造：重点：每次确定次态集合时，要把可能的空转移达到的状态都考虑进去
  >
  > <img src="typora-user-images\image-20220304104803203.png" alt="image-20220304104803203" style="zoom:50%;" />

  <img src="typora-user-images\image-20220304105314873.png" alt="image-20220304105314873" style="zoom:50%;" />

  > 反过来是显然的，因为可以不要空转移，之前证明过了

> $\epsilon-DFA$设计举例：
>
> 多接收状态拼装法，可以**通过空转移完成两个自动机的拼接**
>
> <img src="typora-user-images\image-20220304105528328.png" alt="image-20220304105528328" style="zoom:50%;" />
>
> <img src="typora-user-images\image-20220304105539324.png" alt="image-20220304105539324" style="zoom:50%;" />
...
> 特殊集合的运算：
>
> <img src="typora-user-images\image-20220304110542493.png" alt="image-20220304110542493" style="zoom:50%;" />

#### (一) 正则表达式的递归定义

- 四则运算表达式的递归定义

  <img src="typora-user-images\image-20220304110649833.png" alt="image-20220304110649833" style="zoom:50%;" />

- :star:正则表达式的递归定义

  <img src="typora-user-images\image-20220304110940465.png" alt="image-20220304110940465" style="zoom:67%;" />

  > 举例理解：
  >
  > <img src="typora-user-images\image-20220304111037573.png" alt="image-20220304111037573" style="zoom:67%;" />

- 运算符的优先级：

  <img src="typora-user-images\image-20220304111110462.png" alt="image-20220304111110462" style="zoom:50%;" />

  > 举例：
  >
  > <img src="typora-user-images\image-20220304111330519.png" alt="image-20220304111330519" style="zoom:50%;" />

#### (二) 正则表达式示例

- <img src="typora-user-images\image-20220304111627646.png" alt="image-20220304111627646" style="zoom:50%;" />

- <img src="typora-user-images\image-20220304111730973.png" alt="image-20220304111730973" style="zoom:50%;" />

- <img src="typora-user-images\image-20220304111830006.png" alt="image-20220304111830006" style="zoom:50%;" />

  <img src="typora-user-images\image-20220304111853063.png" alt="image-20220304111853063" style="zoom:50%;" />

- 理解符号$*$的含义，它用来产生各种连续串，为了不让0连续产生，让0跟着个1就可以，但要注意检查特殊情况，即以0结尾的情况

  <img src="typora-user-images\image-20220304112245939.png" alt="image-20220304112245939" style="zoom:50%;" />

  <img src="typora-user-images\image-20220304112328514.png" alt="image-20220304112328514" style="zoom:50%;" />

  > 或者：
  >
  > 用于产生连续的 0 和 1 + 用于接收连续的 0 和 1：
  >
  > <img src="typora-user-images\image-20220304112608917.png" alt="image-20220304112608917" style="zoom:50%;" />
  >
  > <img src="typora-user-images\image-20220304112908298.png" alt="image-20220304112908298" style="zoom:50%;" />
...
> 证明思路：
>
> <img src="typora-user-images\image-20220304113122455.png" alt="image-20220304113122455" style="zoom:50%;" />

#### (一) 由自动机到正则表达式

##### $\Rarr$递归表达式法

- 路径问题：<img src="typora-user-images\image-20220304113328178.png" alt="image-20220304113328178" style="zoom:50%;" />

- 分类讨论：

  <img src="typora-user-images\image-20220304113511829.png" alt="image-20220304113511829" style="zoom:50%;" />
...
- 构造 DFA
  ...
  <img src="typora-user-images\image-20220304113905965.png" alt="image-20220304113905965" style="zoom:50%;" />

- 递归式：

  <img src="typora-user-images\image-20220304114644300.png" alt="image-20220304114644300" style="zoom:50%;" />

- 归纳证明递归式：

  - 归纳基础：$i\ne j$

    <img src="typora-user-images\image-20220304114836253.png" alt="image-20220304114836253" style="zoom:50%;" />

  - 归纳基础：$i=j$

    <img src="typora-user-images\image-20220304114940908.png" alt="image-20220304114940908" style="zoom:50%;" />

  - 归纳假设与递推

    <img src="typora-user-images\image-20220304115053974.png" alt="image-20220304115053974" style="zoom:50%;" />

- 递归表达式应用

  - <img src="typora-user-images\image-20220304115225997.png" alt="image-20220304115225997" style="zoom:50%;" />

    <img src="typora-user-images\image-20220304115249946.png" alt="image-20220304115249946" style="zoom:50%;" />

    <img src="typora-user-images\image-20220304115513107.png" alt="image-20220304115513107" style="zoom:50%;" />

    > 简单的化简规则：
    >
    > <img src="typora-user-images\image-20220304115756198.png" alt="image-20220304115756198" style="zoom:50%;" />

    <img src="typora-user-images\image-20220304120018475.png" alt="image-20220304120018475" style="zoom:50%;" />

    <img src="typora-user-images\image-20220304120116369.png" alt="image-20220304120116369" style="zoom:50%;" />

    <img src="typora-user-images\image-20220304120219964.png" alt="image-20220304120219964" style="zoom:50%;" />

    > 其实算$R_{12}^{(2)}$就够了，然后上一次只算求$R_{12}^{(2)}$需要的就够了。

    <img src="typora-user-images\image-20220304120326197.png" alt="image-20220304120326197" style="zoom:50%;" />

  - <img src="typora-user-images\image-20220304120447501.png" alt="image-20220304120447501" style="zoom:50%;" />

    > 用计算机可以这样算。注意，R代表一个正则表达式，但一般只包含一个接收状态，如果有多个接收状态，通常需要把两个路径**并**起来，也就是两个正则表达式加起来，像图中那样

##### $\Rarr$状态消除法

- 思想/举例解释思想：以某个**状态**为单位，一个一个消

  <img src="typora-user-images\image-20220308084429077.png" alt="image-20220308084429077" style="zoom:50%;" />

- 一般情况

  <img src="typora-user-images\image-20220308084548617.png" alt="image-20220308084548617" style="zoom:50%;" />

  > 重点观察==入边和出边==

> 例题：需要利用**空转移**，先扩展一个开始状态和结束状态，不然最后消得什么也不剩了
>
> （这种方式也可以将多个终态合并到一个上）
>
> <img src="typora-user-images\image-20220308084825518.png" alt="image-20220308084825518" style="zoom:50%;" />
>
> <img src="typora-user-images\image-20220308085128195.png" alt="image-20220308085128195" style="zoom:50%;" />
>
> <img src="typora-user-images\image-20220308085302975.png" alt="image-20220308085302975" style="zoom:50%;" />

#### (二) 由正则表达式到自动机

$\Rarr$*定理 4*

<img src="typora-user-images\image-20220308085409316.png" alt="image-20220308085409316" style="zoom:50%;" />

> 归纳法证明
>
> 归纳基础：
>
> <img src="typora-user-images\image-20220308085617381.png" alt="image-20220308085617381" style="zoom:50%;" />
>
> 归纳递推：
>
> <img src="typora-user-images\image-20220308085748112.png" alt="image-20220308085748112" style="zoom:50%;" />
>
> $+$和连接比较好理解一点，但$*$比较绕，一定要加两个状态和空转移

> 例题：由正则表达式构造$\epsilon-NFA$
>
> 从左向右一点一点构造/使用递归法，把表达式用连接拆成三部分，每部分再分别画
>
> <img src="typora-user-images\image-20220308090439179.png" alt="image-20220308090439179" style="zoom:50%;" />
...
<img src="typora-user-images\image-20220308090655939.png" alt="image-20220308090655939" style="zoom:67%;" />

#### (二) 常用代数定律

- 并运算

  <img src="typora-user-images\image-20220308090738957.png" alt="image-20220308090738957" style="zoom:50%;" />

- 连接运算

  <img src="typora-user-images\image-20220308090833662.png" alt="image-20220308090833662" style="zoom:50%;" />

- 分配律

  <img src="typora-user-images\image-20220308090859600.png" alt="image-20220308090859600" style="zoom:67%;" />

- 闭包运算

  <img src="typora-user-images\image-20220308091053901.png" alt="image-20220308091053901" style="zoom:67%;" />

#### (三) 检验

<img src="typora-user-images\image-20220308091809500.png" alt="image-20220308091809500" style="zoom:50%;" />

> 这种检验方法只适用于带有<u>并、连接和闭包运算</u>的**正则表达式**

> 举例：
>
> <img src="typora-user-images\image-20220308091939329.png" alt="image-20220308091939329" style="zoom:50%;" />
>
> <img src="typora-user-images\image-20220308092334594.png" alt="image-20220308092334594" style="zoom:50%;" />
...
- ##### *补*
  ...
  > **应用**：利用<u>**补**运算的封闭性</u>，证明语言非正则。常用于含否定和情况
  >
...
- 定理：
  ...
  > 这个2中的n是在1中找到的，也就是说，条件要求至少接收两个串，这两个串的长度有这样的关系
...
- 填表算法：
  ...
  > 两个状态经过xxx到达的状态如果是可区分的，则这两个状态也可区分；
  >
  > 最初的可区分是<u>接收状态</u>与<u>非接收状态</u>
...
> 首先终态和非终态之间肯定不可区分；
>
> 然后，经过简短字符（0、1）分别到达终态和非终态的也不可区分
>
...
> 要删除$\epsilon$；把所有满足条件的都写出来，用|隔开，定义为$\epsilon$的，直接把$\epsilon$删除
...
> 级联：从左向右开始，一次拿一个，剩下的都给新变元，直到新变元只剩两个
...
>
> > 这里增加变元标号的办法是**代入**法，但注意代入的时候要代全了
>
> 消除直接
>
...
>    - [开始状态 栈底符号 所有状态都有一个]
> 2. 处理$\delta$
>    - [上一个状态 栈顶符号 接力的最后一个]→ 消耗的终结符 [下一个状态 压入的第1个栈符号 接力1] [接力2 压入的第2个栈符号 接力3] [接力3 压入的第3个栈符号 接力4] ......
>    - 如果说像(4)那样，把栈顶符号弹出后什么也不压入，就直接把次态填写到“接力的最后一个”的位置即可，被产生的只有一个终结符
>
...
>
> 1. 先把终结符写好并处理好
> 2. 然后上升一层，分别连接相邻的两个集合，查看是否有变元可以派生出这个集合中的元素，有的话就写在再上一层的集合中
> 3. 再上一层，最好利用下标的关系，下标的规律：十位是从1开始，个位是从层数开始。计算$X_{ij}$时让k从i到j-1都取一遍，分别利用$X_{ik}$和$X_{k+1~j}$计算
>
